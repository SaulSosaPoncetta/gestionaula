...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold"><i class="bi bi-pencil me-2"></i>Editar ciclo</h4>
    </div>
    <div class="col-auto">
        ...
        <form method="POST" action="{{ route('ciclos.update', $ciclo) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <select name="tipo" class="form-select @error('tipo') is-invalid @enderror" required>
                        ...
                        @foreach($tipos as $tipo)
                            <option value="{{ $tipo }}" {{ old('tipo', $ciclo->tipo) == $tipo ? 'selected' : '' }}>
                ...
                <div class="col-12">
                    ...
                    <textarea name="descripcion" class="form-control" rows="3">{{ old('descripcion', $ciclo->descripcion) }}</textarea>
                </div>
            </div>
