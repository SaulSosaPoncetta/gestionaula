                ...
                <div class="row g-3">
                        ...
                        <select name="ciclo_id" class="form-select">
                            ...
                            @foreach ($ciclos as $ciclo)
                                <option value="{{ $ciclo->id }}"
                                    {{ old('ciclo_id', $materia->ciclo_id) == $ciclo->id ? 'selected' : '' }}>
                                    {{ $ciclo->nombre }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="area_formacion_id" class="form-select">
                            ...
                            @foreach ($areas as $area)
                                <option value="{{ $area->id }}"
                                    {{ old('area_formacion_id', $materia->area_formacion_id) == $area->id ? 'selected' : '' }}>
                                    {{ $area->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="especialidad_id" class="form-select">
                            ...
                            @foreach ($especialidades as $esp)
                                <option value="{{ $esp->id }}"
                                    {{ old('especialidad_id', $materia->especialidad_id) == $esp->id ? 'selected' : '' }}>
                                    {{ $esp->nombre }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="tipomateria" class="form-select">
                            <option value="">—</option>
                            <option value="aula"
                                {{ old('tipomateria', $materia->tipomateria) == 'aula' ? 'selected' : '' }}>Aula</option>
                            <option value="taller"
                                {{ old('tipomateria', $materia->tipomateria) == 'taller' ? 'selected' : '' }}>Taller
                            </option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <select name="tipohora" class="form-select">
                            ...
                            <option value="catedra"
                                {{ old('tipohora', $materia->tipohora) == 'catedra' ? 'selected' : '' }}>Hora cátedra
                            </option>
                            <option value="modulo" {{ old('tipohora', $materia->tipohora) == 'modulo' ? 'selected' : '' }}>
                                Módulo</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="hsporclase" id="hsporclase" class="form-control"
                            value="{{ old('hsporclase', $materia->hsporclase) }}" min="1">
                    </div>
                    <div class="col-md-3">
                        ...
                        <input type="text" id="cantidadclasesanuales" class="form-control bg-light"
                            value="{{ $materia->cantidadclasesanuales }}" placeholder="Se calcula automáticamente"
                            readonly>
                    </div>
                </div>
                <div class="col-md-3">
