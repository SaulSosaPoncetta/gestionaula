...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold"><i class="bi bi-pencil me-2"></i>Editar establecimiento</h4>
    </div>
    <div class="col-auto">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="cue" class="form-control @error('cue') is-invalid @enderror"
                           value="{{ old('cue', $establecimiento->cue) }}">
                ...
                <div class="col-md-3">
                    ...
                    <select name="modalidad" class="form-select @error('modalidad') is-invalid @enderror" required>
                        ...
                        @foreach($modalidades as $m)
                            <option value="{{ $m }}" {{ old('modalidad', $establecimiento->modalidad) == $m ? 'selected' : '' }}>
                ...
                <div class="col-md-6">
                    ...
                    <select name="nivel_id" class="form-select @error('nivel_id') is-invalid @enderror" required>
                        ...
                        @foreach($niveles as $nivel)
                            <option value="{{ $nivel->id }}" {{ old('nivel_id', $establecimiento->nivel_id) == $nivel->id ? 'selected' : '' }}>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" name="localidad" class="form-control"
                           value="{{ old('localidad', $establecimiento->localidad) }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label fw-semibold">Provincia</label>
                    <input type="text" name="provincia" class="form-control"
                           value="{{ old('provincia', $establecimiento->provincia) }}">
                </div>
                <div class="col-md-4">
