...
<div class="row mb-4">
    <div class="col">
        ...
        <p class="text-muted">Planificacion semanal de clases.</p>
    </div>
    <div class="col-auto">
...
@if($horarios->isEmpty())
    <div class="alert alert-info">
        <i class="bi bi-info-circle me-2"></i>No hay horarios cargados todavia.
    </div>
@else
<div class="row g-3">
    @foreach($horarios as $dia => $horariosDelDia)
