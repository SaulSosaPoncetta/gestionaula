...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold"><i class="bi bi-pencil me-2"></i>Editar tipo de evaluación</h4>
    </div>
    <div class="col-auto">
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="{{ route('tiposevaluacion.update', $tiposevaluacion) }}">
            @csrf @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="denominacion"
                           ...
                           value="{{ old('denominacion', $tiposevaluacion->denominacion) }}" required>
