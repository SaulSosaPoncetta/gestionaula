...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold"><i class="bi bi-pencil me-2"></i>Editar especialidad</h4>
    </div>
    <div class="col-auto">
        ...
        <form method="POST" action="{{ route('especialidades.update', $especialidad) }}">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <textarea name="descripcion" class="form-control" rows="3">{{ old('descripcion', $especialidad->descripcion) }}</textarea>
                </div>
            </div>
