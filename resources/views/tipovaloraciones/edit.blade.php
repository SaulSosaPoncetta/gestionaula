...
<div class="row mb-4">
    <div class="col">
        <h4 class="fw-bold"><i class="bi bi-pencil me-2"></i>Editar valoración</h4>
    </div>
    <div class="col-auto">
...
<div class="card border-0 shadow-sm">
    <div class="card-body">
        <form method="POST" action="{{ route('tipovaloraciones.update', $tipovaloracion) }}">
            @csrf @method('PUT')
            ...
            <div class="row g-3">
                <div class="col-12">
                    ...
                    <input type="text" name="denominacion"
                           ...
                           value="{{ old('denominacion', $tipovaloracion->denominacion) }}" required>
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="notainferior"
                           ...
                           value="{{ old('notainferior', $tipovaloracion->notainferior) }}"
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="notasuperior"
                           ...
                           value="{{ old('notasuperior', $tipovaloracion->notasuperior) }}"
                           min="0" max="10" step="0.25" required>
                ...
                <div class="col-md-4">
                    ...
                    <div class="form-control bg-light text-center fw-semibold" id="preview">
                        {{ $tipovaloracion->denominacion }}:
                        {{ number_format($tipovaloracion->notainferior, 2) }}
                        —
                        {{ number_format($tipovaloracion->notasuperior, 2) }}
                    </div>
                </div>
            </div>
