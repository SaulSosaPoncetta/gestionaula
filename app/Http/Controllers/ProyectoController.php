...
class ProyectoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Ordenar: activa primero, luego del horario, luego el resto
        ...
        // Cursos filtrados por materia seleccionada (vía horarios)
        ...
        if ($materiaId) {
            $cursos = Horario::with('curso')
                ...
                ->sortBy(fn($c) => $horario?->curso_id === $c->id ? '0' : '1_'.$c->nombre_completo)
                ->values();
            if ($cursos->isEmpty()) {
        ...
        return view('proyectos.index', compact(
            'proyectos', 'materias', 'cursos', 'materiaActivaId', 'materiasEnHorario'
        ));
    }
